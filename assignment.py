...
def policy_improvement(P, nS, nA, value_from_policy, policy, gamma=0.9):
    ...
    for i in range(nS):
        ...
        new_policy[i]=np.argmax(q_pi) # argmax will return the index where the maximum value of the list is stored, it will be the most suitable action to be taken thus integrated in the updated policy.
